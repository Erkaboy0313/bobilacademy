( () => {
		...
		for ( let n = 1; n < e.length; n += 1 ) {
			...
			if ( null != r && ( i = r, !( "undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && ( 1 === i.nodeType || 11 === i.nodeType ) ) ) ) {
				...
				for ( let s = 0, i = e.length; s < i; s += 1 ) {
					...
					void 0 !== n && n.enumerable && ( v( t[ i ] ) && v( r[ i ] ) ? r[ i ].__swiper__ ? t[ i ] = r[ i ] : w( t[ i ], r[ i ] ) : !v( t[ i ] ) && v( r[ i ] ) ? ( t[ i ] = {}, r[ i ].__swiper__ ? t[ i ] = r[ i ] : w( t[ i ], r[ i ] ) ) : t[ i ] = r[ i ] )
				}
			}
		}
		var i;
	...
	function C( {
		...
		const d = t > n ? "next" : "prev",
			...
			p = () => {
				...
				const r = Math.max( Math.min( ( a - l ) / o, 1 ), 0 ),
	...
	function x( e = {} ) {
		return y || ( y = function ( {
			...
			const p = n.match( /(iPod)(.*OS\s([\d_]+))?/ ),
				...
				h = "Win32" === i;
			let f = "MacIntel" === i;
			return !c && f && t.touch && [ "1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810" ].indexOf( `${l}x${o}` ) >= 0 && ( c = n.match( /(Version)\/([\d.]+)/ ), c || ( c = [ 0, 1, "13_0_0" ] ), f = !1 ), d && !h && ( a.os = "android", a.android = !0 ), ( c || u || p ) && ( a.os = "ios", a.ios = !0 ), a
		}( e ) ), y
	}
	...
	const I = {
		loopCreate: function () {
			...
			for ( let e = 0; e < o.length; e += 1 ) r.append( h( o[ e ].cloneNode( !0 ) ).addClass( s.slideDuplicateClass ) );
	...
	function z( e ) {
		...
		if ( Object.assign( a, {
			...
			let e = !0;
			p.is( a.focusableElements ) && ( e = !1 ), s.activeElement && h( s.activeElement ).is( a.focusableElements ) && s.activeElement !== p[ 0 ] && s.activeElement.blur();
	...
	const F = ( e, t ) => {
		...
		( n.preventClicks || n.preventClicksPropagation ) && a[ p ]( "click", e.onClick, !0 ), n.cssMode && l[ p ]( "scroll", e.onScroll ), n.updateOnWindowResize ? e[ u ]( o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", G, !0 ) : e[ u ]( "observerUpdate", G, !0 )
	};
	const H = {
			attachEvents: function () {
				...
				e.onTouchStart = z.bind( e ), e.onTouchMove = A.bind( e ), e.onTouchEnd = D.bind( e ), s.cssMode && ( e.onScroll = N.bind( e ) ), e.onClick = B.bind( e ), n.touch && !_ && ( t.addEventListener( "touchstart", j ), _ = !0 ), F( e, "on" )
			},
	...
	const W = {
		setBreakpoint: function () {
			...
			u && s && e.changeDirection(), w( e.params, o );
	...
	class K {
		constructor( ...e ) {
			let t, s;
			if ( 1 === e.length && e[ 0 ].constructor && "Object" === Object.prototype.toString.call( e[ 0 ] ).slice( 8, -1 ) ? s = e[ 0 ] : [ t, s ] = e, s || ( s = {} ), s = w( {}, s ), t && !s.el && ( s.el = t ), s.el && h( s.el ).length > 1 ) {
				const e = [];
				return h( s.el ).each( ( t => {
					const i = w( {}, s, {
						el: t
					} );
					e.push( new K( i ) )
			...
			const i = this;
			i.__swiper__ = !0, i.support = E(), i.device = x( {
				userAgent: s.userAgent
			} ), i.browser = M(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [ ...i.__modules__ ], s.modules && Array.isArray( s.modules ) && i.modules.push( ...s.modules );
			const n = {};
			i.modules.forEach( ( e => {
				e( {
					swiper: i,
			...
			const r = w( {}, R, n );
			return i.params = w( {}, r, U, s ), i.originalParams = w( {}, i.params ), i.passedParams = w( {}, s ), i.params && i.params.on && Object.keys( i.params.on ).forEach( ( e => {
	...
	function ie( e, t ) {
		if ( document.querySelector( e ) ) new J( e, function ( e ) {
	...
	J.use( [ function ( {
		...
		function a() {
			...
			t.attr( "data-swiper-autoplay" ) && ( s = t.attr( "data-swiper-autoplay" ) || e.params.autoplay.delay ), clearTimeout( r ), r = f( ( () => {
				let t;
		...
		function l() {
			return void 0 === r && ( !e.autoplay.running && ( e.autoplay.running = !0, n( "autoplayStart" ), a(), !0 ) )
		}

		function o() {
			return !!e.autoplay.running && ( void 0 !== r && ( r && ( clearTimeout( r ), r = void 0 ), e.autoplay.running = !1, n( "autoplayStop" ), !0 ) )
		}
		...
		e.autoplay = {
			...
			if ( e.params.autoplay.enabled ) {
				l();
				i().addEventListener( "visibilitychange", c ), e.params.autoplay.pauseOnMouseEnter && ( e.$el.on( "mouseenter", u ), e.$el.on( "mouseleave", h ) )
			}
