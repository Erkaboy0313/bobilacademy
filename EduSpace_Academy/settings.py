"""
Django settings for EduSpace_Academy project.
...
ROOT_URLCONF = 'EduSpace_Academy.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'eduspace.contex_processor.contactRenderer',
            ],
        },
    },
]

WSGI_APPLICATION = 'EduSpace_Academy.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'whole_media')
